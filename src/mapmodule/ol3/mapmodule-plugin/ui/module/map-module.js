...
define([
    ...
    Oskari.cls('Oskari.mapframework.ui.module.common.MapModule').category({
        _defaultOptions: {
            "maplib": "ol3",
            "srsName": "urn:ogc:def:crs:EPSG:6.3:3067",
            "maxExtent": {
                "bottom": 6291456,
                "left": -548576,
                "right": 1548576,
        ...
        init: function (sandbox) {
            ...
            if (!me._options.maplib || me._options.maplib === "ol2") {
                me._options.maplib = me._defaultOptions.maplib;
                // do conversion from ol2
                if (me._options.srsName === "EPSG:3067") {
                    me._options.srsName = me._defaultOptions.srsName;
                }
                // since the resolutions are identical, but less we'll leave them as is
            }
        ...
        _createMapImpl: function() {
            ...
            if (me._projectionCode === "EPSG:3067") {
                me._projectionCode = "urn:ogc:def:crs:EPSG:6.3:3067";
            }
