define(function() {
     ...
     *
     */
    Oskari.clazz.define('Oskari.ModuleSpec', function (classInfo, className) {
        ...
        category: function (prototype, categoryName) {
            categoryName = categoryName || (['__', Oskari.getSeqNextVal('Category')].join('_'));
            var classInfo = Oskari.clazz.category(
                this.className,
                categoryName,
                prototype
            );
        ...
        methods: function (prototype, categoryName) {
            return this.category(prototype, categoryName);
        },
         ...
         */
        create: function () {
            return Oskari.clazz.createWithClassInfo(this.classInfo, arguments);
        },
         ...
         */
        metadata: function () {
            return Oskari.clazz.getMetadata(this.className);
        },
         ...
         */
        builder: function () {
            return Oskari.clazz.getBuilderFromClassInfo(this.classInfo);
        }
