...
define(function () {
    ...
    var _getPackageDefinition = function (packageName) {
         ...
         */
        var _getClassQName = function (className) {
         ...
         *
         */
        var _cloneProperties = function (from, to) {
            var i,
                propertyName,
                propertyValue,
         ...
         */
        var _createEmptyClassDefinition = function () {
            var ret = function () {
                return undefined;
            };
            ret.prototype = {};
         ...
         *
         */
        var _updateMetadata = function (basePkg, pkg, sp, classInfo, classMeta) {
            var protocols,
                p,
                pt,
                className;
         ...
         * @return
         */
        var _super = function (supCat, supMet) {
            var me = this;
         ...
         * @return {Object}           ClassInfo
         */
        var _pushDown = function (classInfo) {
            var subName,
                pdefsub;
         ...
         * @return {Object}           ClassInfo 
         */
        var _pullDown = function (classInfo) {
            var i,
                category,
                clazz,
                classHierarchy,
    ...
    return {
        ...
        define: function (className, classConstructor, prototype, metadata) {
            ...
            if (!classInfo) {
                classDefinition = _createEmptyClassDefinition();
                composition = {
                    className: className,
                    superClass: null,
                    subClass: null
            ...
            // update prototype
            if (prototype) {
                _cloneProperties(prototype, classInfo._class.prototype);
        ...
        category: function (className, categoryName, prototype) {
            ...
            _cloneProperties(prototype, prot);
            if (prototype) {
